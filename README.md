# При решении данной задачи нужно использовать практику многопоточного программирования, все 45 заданий необходимо выполнять асинхронно и в разных потоках. 
